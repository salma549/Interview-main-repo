...
//             Prepare for Your Dream Job with Personalized Interview Questions
//           </h1>
//           <p className="text-lg mb-8">
//             Upload your resume and get custom-tailored questions to sharpen your skills.
//           </p>
//           <div className="space-x-4">
//             <button className="bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-lg text-lg">
//               Upload Your Resume
//             </button>
//             <button className="bg-white text-purple-600 py-3 px-6 rounded-lg text-lg hover:bg-gray-200">
//               Start Preparing
//             </button>
//           </div>
//         </div>
...
//         <div className="container mx-auto px-4 text-center">
//           <h2 className="text-3xl font-bold text-gray-800 mb-6">Why Use Our Platform?</h2>
//           <p className="text-lg text-gray-600 mb-12">
//             We help you prepare better by generating personalized questions based on your resume. 
//             This will ensure you’re ready for any type of interview, whether technical, behavioral, or company-specific.
//           </p>

//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//             <div className="p-6 bg-gray-50 rounded-lg shadow-lg">
//               <h3 className="text-2xl font-semibold text-blue-500 mb-4">Tailored Interview Questions</h3>
//               <p className="text-gray-600">
//                 Receive questions that align with the job you're targeting, making your practice sessions highly relevant.
//               </p>
//             </div>

//             <div className="p-6 bg-gray-50 rounded-lg shadow-lg">
//               <h3 className="text-2xl font-semibold text-blue-500 mb-4">Resume-Based Preparation</h3>
//               <p className="text-gray-600">
//                 Our AI analyzes your resume and provides the most relevant questions to help you succeed.
//               </p>
//             </div>

//             <div className="p-6 bg-gray-50 rounded-lg shadow-lg">
//               <h3 className="text-2xl font-semibold text-blue-500 mb-4">Answer Tips & Guidance</h3>
//               <p className="text-gray-600">
//                 Get detailed advice on how to answer each question to impress recruiters and ace your interview.
//               </p>
//             </div>
//           </div>
//         </div>
...
//           </h2>
//           <p className="text-lg mb-8">
//             Upload your resume and begin today!
//           </p>
//           <button className="bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-lg text-lg">
//             Upload Your Resume
//           </button>
